...
public class Psql implements PsqlConstants {
        ...
        static private ParsedRequest request = null;

        public static void main(String args[]) throws ParseException{
                try {
                        FileInputStream f = new FileInputStream("/home/workspace/Java/Pjdbc/target/classes/prolog.sql");
  ...
  static final public ParsedRequest parseIt() throws ParseException {
          request = new ParsedRequest();
    SqlSelectStatement();
    jj_consume_token(15);
